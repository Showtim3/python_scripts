...
exports.config = {
  ...
  beforeLaunch: function() {
    ...
    //Check travis files
    var travisYamlFile = fs.readFileSync(path.resolve(__dirname,'../../.travis.yml'), 'utf-8');
    console.log(travisYamlFile);
    // var travisYamlData = yaml.safeLoad(travisYamlFile);
    // console.log(travisYamlData);
    // console.log(travisYamlData.env.jobs);
    // console.log('Jobs length is');
    // console.log(travisYamlData.env.jobs.length);
    // console.log(travisYamlData.script);
    // console.log('Script length is');
    // console.log(travisYamlData.script.length);
